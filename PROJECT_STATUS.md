...
- The active engine now imports canonical maximum drawdown fraction accounting, fails loudly on invalid equity, and stops at the current processed bar without reading future prices when its frozen cutoff is breached
