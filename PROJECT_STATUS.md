...
Isolate the active engine's fixed, risk-percent, and ATR-based position sizing so the notebook shares one importable verified implementation with deterministic regression coverage.
