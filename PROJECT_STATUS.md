...
- The active engine now imports canonical intrabar stop/target resolution, preserving Bid-triggered long exits, Ask-triggered short exits, gap-through-open execution, and conservative stop-first same-bar ambiguity
